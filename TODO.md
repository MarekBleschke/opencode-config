...
2. Make oc-sandbox usable by other users:
  - adding new profiles shouldn't require changes in @sandbox/ scripts:
  - all code related to profiles should be generic and not tied to names. `profiles/<profile-name>/` - this is contract for profile, directory structure
